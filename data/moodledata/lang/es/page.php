...
/**
 * Strings for component 'page', language 'es', version '3.10'.
 *
 * @package     page
 * @category    string
...
$string['printlastmodifiedexplain'] = '¿Mostrar última fecha de modificación debajo del contenido?';
$string['privacy:metadata'] = 'El complemento de recurso de página no almacena ningún dato personal.';

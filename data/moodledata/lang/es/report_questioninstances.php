...
/**
 * Strings for component 'report_questioninstances', language 'es', version '3.10'.
 *
...
$string['reportforqtype'] = 'Informe para el tipo de pregunta \'{$a}\'';
$string['reportsettings'] = 'Parámetros del informe';

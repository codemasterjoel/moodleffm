...
/**
 * Strings for component 'question', language 'es', version '3.10'.
 *
 * @package     question
 * @category    string
...
$string['questionsinuse'] = '(*Las preguntas marcadas con un asterisco ya están en uso en algún lugar como por ejemplo un cuestionario. Por lo tanto, si continua, estas preguntas no serán borradas de forma real, solo se ocultarán.)';

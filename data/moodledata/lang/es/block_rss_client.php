...
/**
 * Strings for component 'block_rss_client', language 'es', version '3.10'.
 *
...
$string['editfeeds'] = 'Editar, suscribir o dar de baja de fuentes de noticias RSS/Atom';
...
$string['enableautodiscovery_help'] = 'Si está habilitado se encontrarán automáticamente las fuentes en páginas web. Por ejemplo, si se introduce http://docs.moodle.org, se encontrará http://docs.moodle.org/en/index.php?title=Special:RecentChanges&feed=rss.';
$string['failedfeed'] = 'No se pudo descargar la fuente - se volverá a intentar después de {$a}';
$string['failedfeeds'] = 'Una o más fuentes RSS han fallado';
$string['feed'] = 'Canal';
$string['feedadded'] = 'Añadido canal de noticias';
$string['feeddeleted'] = 'Eliminado canal de noticias';
$string['feeds'] = 'Fuentes de noticias';
$string['feedsaddedit'] = 'Añadir/editar fuentes';
...
$string['pluginname'] = 'Canal RSS remoto';
$string['privacy:metadata:block_rss_client:description'] = 'La descripción de la fuente RSS.';
$string['privacy:metadata:block_rss_client:preferredtitle'] = 'El título preferido (personalizado) de la fuente RSS.';
$string['privacy:metadata:block_rss_client:shared'] = 'Si la fuente RSS está disponible para todos los cursos.';
$string['privacy:metadata:block_rss_client:skiptime'] = 'El tiempo, definido en segundos, que el cron esperará entre intentos de conectar con las fuentes RSS que hayan fallado.';
$string['privacy:metadata:block_rss_client:skipuntil'] = 'El tiempo máximo definido que el cron esperará para abrir fuentes RSS que hayan fallado.';
$string['privacy:metadata:block_rss_client:tableexplanation'] = 'La información del bloque RSS se almacena aquí.';
$string['privacy:metadata:block_rss_client:title'] = 'El título de la fuente RSS.';
$string['privacy:metadata:block_rss_client:url'] = 'La URL de la fuente RSS.';
$string['privacy:metadata:block_rss_client:userid'] = 'El ID del usuario que añadió la fuente RSS.';
$string['refreshfeedstask'] = 'Actualizar la tarea de fuentes RSS';
$string['remotenewsfeed'] = 'Fuente de noticias remota';
...
$string['rss_client:myaddinstance'] = 'Añadir un nuevo bloque de fuente remota RSS al Área personal';

...
/**
 * Strings for component 'theme_adaptable', language 'es', version '3.10'.
 *
...
$string['collapsedtopicscoloursenabled'] = 'Temas Contraídos, alternan la configuración de color de primer plano y de fondo';
$string['collapsedtopicscoloursenableddesc'] = 'Utilice la configuración de color de primer plano y fondo de Temas Contraídos en lugar de la configuración de \'sectionheadingcolor\' y \'coursesectionheaderbg\' de Adaptable.';
...
$string['informationsettings'] = 'Información de configuración';
...
$string['navbardropdowntexthovercolordesc'] = 'Color del texto del menú desplegable al pasar el cursor sobre los elementos del menú.';

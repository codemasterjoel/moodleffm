...
/**
 * Strings for component 'enrol_ldap', language 'es', version '3.10'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['autoupdate_settings_desc'] = '<p>Seleccione los campos a actualizar cuando la tarea programada \'Sincronizar inscripciones LDAP\' se ejecute.</p><p>Cuando se seleccione, al menos, un campo se producirá una actualización.</p>';
...
$string['course_fullname_updateonsync'] = 'Actualizar el nombre completo durante el script de sincronización';
...
$string['course_shortname_updateonsync'] = 'Actualizar el nombre corto durante el script de sincronización';
...
$string['createcourseextid'] = 'CREAR Usuario inscrito en un curso inexistente \'{$a->courseextid}\'';
...
$string['duplicateshortname'] = 'Fallo en la creación del curso. Duplicar nombre de archivo corto. Omitir curso con número de identificación \'{$a->idnumber}\'...';

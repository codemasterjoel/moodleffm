...
/**
 * Strings for component 'tool_behat', language 'es', version '3.10'.
 *
 * @package     tool_behat
 * @category    string
...
$string['errorapproot'] = '$CFG->behat_ionic_dirroot no hace referencia a una instalación válida de desarrollador de la aplicación Moodle.';

...
/**
 * Strings for component 'blog', language 'es', version '3.10'.
 *
 * @package     blog
 * @category    string
...
$string['blogdeleteconfirm'] = '¿Eliminar la entrada de blog \'{$a}\'?';
...
$string['courseblogdisable'] = 'Los blogs del curso no están habilitados';

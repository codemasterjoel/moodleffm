...
/**
 * Strings for component 'availability_group', language 'es', version '3.10'.
 *
...
$string['description'] = 'Permitir sólo a estudiante que pertenezcan a un determinado grupo o a todos los grupos.';
...
$string['requires_notgroup'] = 'No perteneces a <strong>{$a}</strong>';
$string['title'] = 'Grupo';

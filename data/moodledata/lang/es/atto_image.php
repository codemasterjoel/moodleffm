...
/**
 * Strings for component 'atto_image', language 'es', version '3.10'.
 *
 * @package     atto_image
 * @category    string
...
$string['createimage'] = 'Insertar imagen';
...
$string['pluginname'] = 'Insertar o editar imagen';
...
$string['privacy:metadata'] = 'El complemento atto_image no almacena ningún dato personal.';
$string['saveimage'] = 'Guardar imagen';
$string['size'] = 'Tamaño';
$string['uploading'] = 'Subiendo, espere por favor...';
$string['width'] = 'Ancho';

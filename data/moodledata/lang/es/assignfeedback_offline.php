...
/**
 * Strings for component 'assignfeedback_offline', language 'es', version '3.10'.
 *
...
$string['gradesfile_help'] = 'Calificación mediante hoja de cálculo con calificaciones modificadas. El archivo debe ser un fichero CSV con codificación UTF-8 que se haya descargado desde esta tarea y debe contener las columnas de la calificación de los estudiantes y el identificador.';
...
$string['privacy:nullproviderreason'] = 'Este plugin no tiene una base de datos para almacenar información del usuario. Solo utiliza APIs en mod_assign para ayudar a mostrar la interfaz de calificación.';

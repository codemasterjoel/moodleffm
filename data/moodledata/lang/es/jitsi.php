...
/**
 * Strings for component 'jitsi', language 'es', version '3.10'.
 *
 * @package     jitsi
 * @category    string
...
$string['blurbutton'] = 'Opción Difuminado';
$string['blurbuttonex'] = 'Mostrar la opción difuminado';
...
$string['loginyoutube'] = 'Iniciar sesión en youtube';
$string['logoutyoutube'] = 'Cerrar sesión en youtube';
$string['mailprivacy'] = 'El correo electrónico solo se utilizará para la opción gravatar';
...
$string['startstream'] = 'Iniciar stream';
$string['stopstream'] = 'Parar stream';
...
$string['validitytime'] = 'Tiempo de validesz';
$string['validitytime_help'] = 'Tiempo de validez del enlace';

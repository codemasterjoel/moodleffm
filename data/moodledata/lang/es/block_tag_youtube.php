...
/**
 * Strings for component 'block_tag_youtube', language 'es', version '3.10'.
 *
...
$string['categoryerror'] = 'Falló al obtener la lista de categorías. <br> {$a}';
$string['comedy'] = 'Comedia';
$string['configtitle'] = 'Título del bloque de Youtube';
...
$string['howtodiy'] = 'How-to y DIY';
$string['includeonlyvideosfromplaylist'] = 'Incluir sólo videos de la lista con id';
$string['music'] = 'Música';
$string['newspolitics'] = 'Noticias y Política';
$string['nonprofitactivism'] = 'Organizaciones sin ánimo de lucro y Activismo';
$string['numberofvideos'] = 'Número de videos';
$string['peopleblogs'] = 'Gente y Blogs';
$string['petsanimals'] = 'Mascotas y Animales';
$string['pluginname'] = 'YouTube';
$string['privacy:metadata'] = 'El bloque de Youtube solo muestra información almacenada en otros lugares.';

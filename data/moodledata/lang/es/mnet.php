...
/**
 * Strings for component 'mnet', language 'es', version '3.10'.
 *
 * @package     mnet
 * @category    string
...
$string['configmnet'] = 'MNet permite la comunicación de este servidor con otros servidores o servicios.';
...
$string['expireyourkeyexplain'] = 'Moodle automáticamente rota sus claves cada 28 días (por defecto) pero usted tiene la opción de hacer expirar esta clave en cualquier momento <em>manualmente</em>. Lo anterior sería útil únicamente si cree que esta clave ha sido comprometida. Se generará un reemplazo de forma automática.<br />Eliminar esta clave hará imposible que otras aplicaciones se comuniquen con usted hasta que contacte con cada administrador y les facilite su nueva clave.';
...
$string['http_self_signed_help'] = 'Permitir conexiones usando un certificado SSL autofirmado DIY en el host remoto.';
$string['http_verified_help'] = 'Permitir conexiones usando un certificado verificado SSL en PHP en el host remoto, pero a través http (no https).';
...
$string['mnetidprovider'] = 'Proveedor de ID MNET';
...
$string['nomodifyacl'] = 'No tiene permitido modificar la lista de control de acceso de MNet.';
...
$string['nosuchmodule'] = 'La ruta de la función es incorrecta y no pudo ser localizada. Por favor use el formato: mod/Nombre_Modulo/lib/Nombre_Funcion.';
...
$string['privacy:metadata'] = 'El complemento MNet no almacena ningún dato personal.';
...
$string['reallydeleteserver'] = '¿Está seguro de que desea eliminar el servidor?';
...
$string['remoteuserinfo'] = 'Perfil obtenido de<a href="{$a->remoteurl}">{$a->remotename}</a>';
...
$string['selectahost'] = 'Por favor seleccione un host remoto.';

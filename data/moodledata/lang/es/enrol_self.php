...
/**
 * Strings for component 'enrol_self', language 'es', version '3.10'.
 *
 * @package     enrol_self
 * @category    string
...
$string['status_help'] = 'Si está habilitado junto con \'Permitir nuevas inscripciones\' deshabilitado, solo los usuarios que se inscribieron previamente pueden acceder al curso. Si está deshabilitado, este método de autoinscripción está efectivamente inhabilitado, ya que todas las autoinscripciones existentes están suspendidas y los nuevos usuarios no pueden autoinscribirse.';

...
/**
 * Strings for component 'atto_c4l', language 'es', version '3.10'.
 *
 * @package     atto_c4l
 * @category    string
...
$string['dialogtitle'] = 'Elige un componente';
$string['dodontcards'] = 'Recuadros Correcto/Incorrecto';
$string['duedate'] = 'Fecha límite';
$string['enableattoc4l'] = 'Habilita Componentes para el aprendizaje';
...
$string['generalheading'] = 'Ajustes generales';

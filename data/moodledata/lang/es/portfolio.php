...
/**
 * Strings for component 'portfolio', language 'es', version '3.10'.
 *
 * @package     portfolio
 * @category    string
...
$string['instanceismisconfigured'] = 'La instancia de portafolios está mal configurada y se ha pasado por alto. El error fue: {$a}';
...
$string['privacy:metadata:portfolio_log'] = 'Registro de transferencias de portafolios (usada para revisar más tarde si hay duplicados)';
$string['privacy:metadata:portfolio_log:caller_class'] = 'Nombre de la clase usada para crear la transferencia';
$string['privacy:metadata:portfolio_log:caller_component'] = 'Nombre del componente responsable de la exportación';
$string['privacy:metadata:portfolio_log:time'] = 'Hora de transferencia (en caso de una transferencia en cola, este es el momento en el que se efectuó la transferencia, no cuando la inició el usuario)';

...
/**
 * Strings for component 'zoom', language 'es', version '3.10'.
 *
 * @package     zoom
 * @category    string
...
$string['zoomerr_apikey_missing'] = 'Clave de la API de Zoom no encontrada.';
$string['zoomerr_apisecret_missing'] = 'API secreta de Zoom no encontrada.';

...
/**
 * Strings for component 'questionnaire', language 'es', version '3.10'.
 *
...
$string['submissionnotificationhtmluser'] = 'Hay un nuevo <a href="{$a->submissionurl}">envío</a> de la encuesta "{$a->name}" realizado por "<a href="{$a->profileurl}">{$a->username}</a>".';
...
$string['submissionnotificationtextuser'] = 'Hay un nuevo envío ({$a->submissionurl}) de la encuesta "{$a->name}" realizado por "{$a->username}" ({$a->profileurl}).';

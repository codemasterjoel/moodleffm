...
/**
 * Strings for component 'payment', language 'es', version '3.10'.
 *
 * @package     payment
 * @category    string
...
$string['gotopaymentaccounts'] = 'Usted puede crear múltiples cuentas de pagos usando cualquiera de estos portales de pagos en la página  {$a}';

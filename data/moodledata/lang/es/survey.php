...
/**
 * Strings for component 'survey', language 'es', version '3.10'.
 *
 * @package     survey
 * @category    string
...
$string['guestsnotallowed'] = 'Sólo los usuarios matriculados pueden enviar encuestas';
...
$string['notyetanswered'] = 'Aún no se ha dado respuesta';
...
$string['privacy:metadata:analysis'] = 'Un registro del análisis de respuestas de la encuesta.';
$string['privacy:metadata:analysis:notes'] = 'Notas guardadas con las respuestas de un usuario.';
$string['privacy:metadata:analysis:userid'] = 'El ID del usuario que responde a la encuesta.';
$string['privacy:metadata:answers'] = 'Una colección de respuestas a encuestas.';
...
$string['privacy:metadata:answers:time'] = 'La hora en la que se publicó la respuesta.';
...
$string['responsereports'] = 'Informes de respuesta';

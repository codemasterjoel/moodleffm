...
/**
 * Strings for component 'report_log', language 'es', version '3.10'.
 *
 * @package     report_log
 * @category    string
...
$string['nocapability'] = 'No se puede acceder al informe de registro de usuario';
$string['nologreaderenabled'] = 'Ningún lector de registro activado';
$string['origin'] = 'Fuente';
$string['other'] = 'Otro';
...
$string['privacy:metadata'] = 'El complemento de registros no almacena ningún dato personal.';

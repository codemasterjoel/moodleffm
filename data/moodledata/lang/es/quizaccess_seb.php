...
$string['seb_linkquitseb_help'] = 'En este campo puede introducir un enlace para salir de SEB. Se utilizará en un botón con el texto "Salir de Safe Exam Browser" que estará en la página que aparece después de enviar el examen. Cuando se haga clic en el botón o en el enlace situado donde usted quiera, será posible salir de SEB sin tener que proporcionar una contraseña de salida. Si no se introduce ningún enlace entonces el botón con texto "Salir de Safe Exam Browser" no aparecerá y no habrá ningún enlace establecido para salir de SEB.';
...
$string['setting:autoreconfigureseb_desc'] = 'S';

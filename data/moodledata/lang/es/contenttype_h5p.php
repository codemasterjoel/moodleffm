...
/**
 * Strings for component 'contenttype_h5p', language 'es', version '3.10'.
 *
...
$string['description'] = 'Contenido interactivo H5P';
$string['h5p:access'] = 'Acceso a contenido H5P en el banco de contenido';
$string['h5p:upload'] = 'Subir un nuevo contenido H5P';

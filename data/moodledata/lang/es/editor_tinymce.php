...
/**
 * Strings for component 'editor_tinymce', language 'es', version '3.10'.
 *
...
$string['advanced:blockquote'] = 'Cita en bloque';
$string['advanced:blockquote_desc'] = 'Cita en bloque';
...
$string['advlink_dlg:accesskey'] = 'Clave de acceso';
...
$string['autosave:warning_message'] = 'Si restaura el contenido guardado, perderá todo el contenido que se encuentre actualmente en el editor.
...
$string['fullpage_dlg:meta_noindex_nofollow'] = 'No indexar y no seguir los vínculos';
...
$string['fullpage_dlg:src'] = 'Origen';
...
$string['media_dlg:swstretchstyle'] = 'Estirar estilo';
...
$string['privacy:metadata'] = 'El complemento de editor HTML TinyMCE no almacena ningún dato personal.';

...
/**
 * Strings for component 'assignfeedback_comments', language 'es', version '3.10'.
 *
...
$string['pluginname'] = 'Comentarios de retroalimentación';
...
$string['privacy:metadata:filepurpose'] = 'Ficheros de retroalimentación del profesor para el estudiante.';
$string['privacy:metadata:gradepurpose'] = 'El ID de la calificación asociada con el comentario.';
$string['privacy:metadata:tablesummary'] = 'Esto almacena comentarios hechos por los correctores como retroalimentación para el estudiante en sus envíos.';

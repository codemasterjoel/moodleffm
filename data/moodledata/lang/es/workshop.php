...
/**
 * Strings for component 'workshop', language 'es', version '3.10'.
 *
 * @package     workshop
 * @category    string
...
$string['assessmentstartevent'] = '{$a} se abre para evaluación';
...
$string['crontask'] = 'Procesamiento en segundo plano para el módulo de taller';
...
$string['privacy:metadata:aggregatedgradinggrade'] = 'Calificación agregada para todas las evaluaciones realizadas por el usuario en la actividad del taller dada';
$string['privacy:metadata:assessmentgrade'] = 'Calificación agregada para la presentación sugerida por esta evaluación';
$string['privacy:metadata:assessmentgradinggrade'] = 'Calificación para satisfacer esta evaluación';
$string['privacy:metadata:assessmentgradinggradeover'] = 'Valor anulado manualmente de la calificación para satisfacer esta evaluación';
$string['privacy:metadata:assessmentid'] = 'ID de la evaluación';
$string['privacy:metadata:authorid'] = 'ID del autor del envío';
$string['privacy:metadata:dimensiongrade'] = 'Calificación en la dimensión de la evaluación proporcionada';
$string['privacy:metadata:dimensionid'] = 'ID de la dimensión de la evaluación';
$string['privacy:metadata:example'] = 'Si este registro representa un ejemplo de envío';
...
$string['privacy:metadata:late'] = 'Si el envío se envió después de la fecha límite';
$string['privacy:metadata:peercomment'] = 'Comentar la calificación otorgada por el usuario que realiza la evaluación';
$string['privacy:metadata:peercommentformat'] = 'Formato de texto del comentario en la calificación otorgada';
$string['privacy:metadata:preference:perpage'] = 'Número de envíos que el usuario prefiere ver en una página';
$string['privacy:metadata:preference:viewlet-allexamples-collapsed'] = 'El estado colapsado/extendido para el viewlet \'Envíos de ejemplo\'';
$string['privacy:metadata:preference:viewlet-allsubmissions-collapsed'] = 'El estado contraído/expandido del viewlet \'Informe de envíos del taller\'.';
$string['privacy:metadata:preference:viewlet-assessmentform-collapsed'] = 'El estado contraído/expandido del viewlet \'Formulario de evaluación\'.';
$string['privacy:metadata:preference:viewlet-assignedassessments-collapsed'] = 'El estado contraído/expandido del viewlet \'Envíos asignados para evaluar\'.';
$string['privacy:metadata:preference:viewlet-cleargrades-collapsed'] = 'El estado contraído/expandido del viewlet \'Caja de herramientas de taller\'.';
$string['privacy:metadata:preference:viewlet-conclusion-collapsed'] = 'El estado contraído/expandido del viewlet \'Conclusión\'.';
$string['privacy:metadata:preference:viewlet-examples-collapsed'] = 'El estado contraído/expandido del viewlet \'Envíos de ejemplo para evaluar\'.';
$string['privacy:metadata:preference:viewlet-examplesfail-collapsed'] = 'El estado contraído/expandido del viewlet \'Envíos de ejemplo para evaluar\'.';
$string['privacy:metadata:preference:viewlet-gradereport-collapsed'] = 'El estado contraído/expandido del viewlet \'Informe de calificaciones de Taller\'.';
$string['privacy:metadata:preference:viewlet-instructauthors-collapsed'] = 'El estado contraído/expandido del viewlet \'Instrucciones de envío\'.';
$string['privacy:metadata:preference:viewlet-instructreviewers-collapsed'] = 'El estado contraído/expandido del viewlet \'Instrucciones para la evaluación\'.';
$string['privacy:metadata:preference:viewlet-intro-collapsed'] = 'El estado contraído/expandido del viewlet \'Introducción\'.';
$string['privacy:metadata:preference:viewlet-overallfeedback-collapsed'] = 'El estado contraído/expandido del viewlet \'Retroalimentación general\'.';
$string['privacy:metadata:preference:viewlet-ownsubmission-collapsed'] = 'El estado contraído/expandido del viewlet \'Su envío\'.';
$string['privacy:metadata:preference:viewlet-publicsubmissions-collapsed'] = 'El estado contraído/expandido del viewlet \'Envíos publicados\'.';
$string['privacy:metadata:preference:viewlet-yourgrades-collapsed'] = 'El estado contraído/expandido del viewlet \'Tus calificaciones\'.';
$string['privacy:metadata:published'] = 'Si el envío debería publicarse para todos los participantes una vez que el taller se ha cerrado';
$string['privacy:metadata:reviewerid'] = 'ID del usuario que proporciona la evaluación';
$string['privacy:metadata:strategy'] = 'Nombre del complemento de segundo nivel de estrategia de calificación que interpreta los valores del registro';
$string['privacy:metadata:submissioncontent'] = 'Contenido del envío';
$string['privacy:metadata:submissioncontentformat'] = 'Formato de texto del contenido del envío';
$string['privacy:metadata:submissiongrade'] = 'Calificación agregada para la presentación escrita como un número decimal del intervalo 0..100';
$string['privacy:metadata:submissiongradeover'] = 'Valor anulado manualmente de la calificación agregada';
$string['privacy:metadata:submissionid'] = 'ID del envío';
$string['privacy:metadata:submissiontitle'] = 'Título del envío';
$string['privacy:metadata:subsystem:corefiles'] = 'El módulo de taller almacena archivos incrustados / adjuntos al texto de envío';
$string['privacy:metadata:subsystem:coreplagiarism'] = 'El módulo de taller tiene soporte incorporado para sistemas de prevención de plagio';
$string['privacy:metadata:timeaggregated'] = 'Cuando la calificación agregada se calculó por última vez';
$string['privacy:metadata:timecreated'] = 'Cuando se creó este registro en la base de datos';
$string['privacy:metadata:timemodified'] = 'Cuando se modificó por última vez este registro en la base de datos';
$string['privacy:metadata:userid'] = 'ID del usuario para el que se calcula la calificación agregada';
$string['privacy:metadata:weight'] = 'Peso del envío';
$string['privacy:metadata:workshopaggregations'] = 'Contiene calificaciones agregadas para evaluación';
$string['privacy:metadata:workshopassessments'] = 'Contiene información sobre las evaluaciones asignadas de los envíos del módulo de taller';
$string['privacy:metadata:workshopgrades'] = 'Contiene información sobre cómo se rellenaron los formularios de evaluación con calificaciones y comentarios';
$string['privacy:metadata:workshopid'] = 'ID de la actividad de taller';
$string['privacy:metadata:workshopsubmissions'] = 'Contiene información sobre envíos del módulo de taller';
$string['privacy:request:delete:content'] = 'El contenido ha sido eliminado (solicitado por el usuario o ha expirado)';

...
/**
 * Strings for component 'repository_filesystem', language 'es', version '3.10'.
 *
...
$string['nosubdir'] = 'Necesita crear al menos una carpeta dentro del directorio <b>{$a}</b> para poder seleccionarla allí.';

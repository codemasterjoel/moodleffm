...
/**
 * Strings for component 'editor', language 'es', version '3.10'.
 *
 * @package     editor
 * @category    string
...
$string['acteditorshhdr'] = 'Editores de texto disponibles';
...
$string['cols'] = 'Cols';
$string['configeditorplugins'] = 'Por favor, elija los conectores (\'plugins\') de editor que desea usar y colóquelos en el orden recomendado.';
...
$string['nolink'] = 'Anular el enlace automático al glosario';
...
$string['privacy:metadata:preference:htmleditor'] = 'Preferencia de editor de texto.';
$string['privacy:preference:htmleditor'] = 'Su editor preferido para escribir texto HTML es {$a}';
